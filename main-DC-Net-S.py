...
from DC_Net_S import Training_DC_Net, Inference_DC_Net
import logging
import sys
...
def valid(net_test,state_dict, valid_dataloaders, valid_datasets, hypar, epoch=0):
    # print("test:",net_test.state_dict().keys())
    # print("train:",state_dict.keys())
    if state_dict is not None:
        test_state_dict=net_test.state_dict()
        ...
        net_test.load_state_dict(test_state_dict)
    net_test.eval()
    print("Validating...")
    epoch_num = hypar["max_epoch_num"]
...
if __name__ == "__main__":
    ...
    # hypar["crop_size"] = [288, 288]
    hypar["random_flip_h"] = 1
    hypar["random_flip_v"] = 0

    print("building model...")
    hypar["model_train"] = Training_DC_Net()
    hypar["model_test"] = Inference_DC_Net()
    ...
    dataset_train1 = {"name": "DUTS-TR",
            ...
            "im_ext": ".jpg",
            "gt_ext": ".png",
            "cache_dir":"./datasets/DUTS-TR/cache_384"}
    ...
    dataset_valid1 = {"name": "DUTS-TE",
                    ...
                    "im_ext": ".jpg",
                    "gt_ext": ".png",
                    "cache_dir":"./datasets/DUTS-TE/cache_384"}
