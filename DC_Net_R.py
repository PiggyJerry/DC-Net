...
class Inference_DC_Net(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        resnet = parallel_resnet.parallel_resnet34(pretrained=False,parallel=2)

        ## -------------Encoder--------------
        self.conv_in = nn.Conv2d(in_ch*2,64*2,3,stride=2,padding=1,groups=2)
    ...
    def forward(self,x):
        ...
        hxin = self.conv_in(hx.repeat(1,2,1,1))
